...
public abstract class CorpseMapper {
	...
	@Mapping(target = "transport.branch", ignore = true)
	@Mapping(target = "nextOfKins", ignore = true)
	@Mapping(target = "transport.vehicle.id", ignore = true)
	@Mapping(target = "transport.vehicle.branch", ignore = true)
	@Mapping(target = "transport.createdBy", ignore = true)
	@Mapping(target = "releasedCorpse.id", ignore = true)
	@Mapping(target = "fromOtherMortuary.id", ignore = true)
	@Mapping(target = "fromOtherMortuary.branch", ignore = true)
	@Mapping(target = "fromOtherMortuary.createdBy", ignore = true)
